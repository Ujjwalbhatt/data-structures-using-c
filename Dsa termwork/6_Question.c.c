// Q6.Write a C program to create a double linked list by inserting nodes in such a way that the resultant linked list remains in ascending order.(do not use any sorting technique).
// SOURCE CODE:
#include<stdio.h>
#include<stdlib.h>
struct Node
